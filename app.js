...
// --- Pengumpulan projek (berbilang unit dalam hartanah sama, cth projek 3 lot/2 unit) ---
function projSlug(l) {
...
function projectCard(units) {
  ...
  <article class="card card-proj">
    ...
    <div class="card-body">
      ...
      <p class="card-desc">${count} unit tersedia: ${unitLabels}. Bandingkan harga, saiz & ciri setiap unit.</p>
